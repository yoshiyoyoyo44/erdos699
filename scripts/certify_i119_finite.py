...
def main():
    near=json.loads(artifact_path('verification_near_collisions_a100.json').read_text(encoding='utf-8'))
    ...
    artifact_path('i119_finite_certificate.json').write_text(json.dumps(result,indent=2)+'\n',encoding='utf-8')
