...
def main():
    cert=json.loads(artifact_path('critical_index_certificate.json').read_text(encoding='utf-8'))
    ...
    artifact_path('verification_critical_indices.json').write_text(json.dumps(result,indent=2)+'\n',encoding='utf-8')
