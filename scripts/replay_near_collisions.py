...
def main():
    cert=json.loads(artifact_path('near_collision_certificate.json').read_text(encoding='utf-8'))
    ...
    artifact_path('verification_near_collisions.json').write_text(json.dumps(result,indent=2)+'\n',encoding='utf-8')
