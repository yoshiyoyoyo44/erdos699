...
with artifact_path('large_index_certificate.json').open(encoding='utf-8') as f:
    cert=json.load(f)
with artifact_path('prime_gap_certificate.json').open(encoding='utf-8') as f:
...
with artifact_path('verification_large_indices.json').open('w', encoding='utf-8') as f:
