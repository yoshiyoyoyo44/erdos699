...
**続報：** [全素因数の桁和と因子次数の続稿](i3_digit_height_budget_and_factor_degrees_2026-09-23.md)で、桁多項式の上界を Q₁ の全素数冪へ集約し、j の偶奇を問わない明示的不等式を証明した。任意次数の因子分配の制限も得たが、F_K の下界と矛盾する一様な上界はまだない。
